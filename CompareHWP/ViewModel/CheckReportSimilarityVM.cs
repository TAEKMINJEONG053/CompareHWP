...
namespace CompareHWP.ViewModel
{
    public class CheckReportSimilarityVM : ViewModelBase
    {
        ...
        private ObservableRangeCollection<SimilarityResult> _similarityResults;
        public ObservableRangeCollection<SimilarityResult> SimilarityResults
        {
        ...
        public CheckReportSimilarityVM()
        {
            ...
            SimilarityResults = new ObservableRangeCollection<SimilarityResult>();
        ...
        public void RemoveFileClick(object parameter)
        {
        ...
        private async void AnalyzeCommandClick(object parameter)
        {
            if (FileList.Count == 0)
            ...
            else
            {
                ...
                await Task.Run(() =>
                {
                    ...
                    SimilarityResults.AddRange(results.OrderByDescending(p => p.Similarity));
                });
